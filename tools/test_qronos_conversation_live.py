...
def wake_detected_feedback(
    ...
    print("NOW SAY YOUR FIRST MESSAGE.")
    print("!" * 60)
    print()
...
def main() -> int:
    ...
    print("=" * 60)
    print(
        "QRONOS MULTI-TURN CONVERSATION LIVE TEST"
    )
    print("=" * 60)
    print()
    ...
    try:
        for turn_number in range(
            ...
            if turn_number == 1:
                ...
                print()
                print(
                    "Tell me what twenty plus five is."
                )
                ...
                print()
                print(
                    "This time test a natural pause."
                )
                ...
                print(
                    "[pause naturally for about "
                    "1 to 1.5 seconds]"
                )

                print(
                    "...what thirty plus five is."
                )
            ...
            if (
                turn_number > 1
                and result.wake_event is not None
            ):
                print()
                print(
                    "ERROR: Follow-up turn "
                    "unexpectedly used a wake word."
                )
